...
//                         <h2>{data.name}</h2>
//                     </div>
//                     <div className=" icon" onClick={collapse}>
//                         {!expand && <img src="https://img.icons8.com/?size=100&id=24717&format=png&color=000000" className="icon"/>}
//                         {expand && <img src="https://img.icons8.com/?size=100&id=1504&format=png&color=000000" className="icon"/>}
//                     </div>
//                     </div>
//                     {expand &&
//                     <>

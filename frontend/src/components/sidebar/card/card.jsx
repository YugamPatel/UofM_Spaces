...
//     <>
//       {!isCollapsable && (
//         <div className="outer-card" id={cardId} onClick={onClick}>
        ...
        >
            ...
            {typeof timings === "string" && (
                <>
                    {isOpen(timings) === "Closed" && (
                        <div className="status-closed">
                            <img className="status-icon" src="https://img.icons8.com/?size=100&id=10247&format=png&color=FFFFFF" alt="Closed Icon"/>
                            <p> Closed</p>
                        </div>
                    )}
                    {isOpen(timings) === "Open" && (
                        <div className="status-open">
                            <img className="status-icon" src="https://img.icons8.com/?size=100&id=10247&format=png&color=FFFFFF" alt="Open Icon"/>
                            <p> Open</p>
                        </div>
                    )}
                </>
            ...
            <div className="location">
                <img className="status-icon" src="https://img.icons8.com/?size=100&id=9361&format=png&color=FFFFFF" alt="Location Icon"/>
                <p>{location}</p>
            </div>
            ...
            {isCollapsable && isExpanded && (
                <div className="collapsible-content show">
                    <div className="timing-header" style={{color : "white"}}>Timings:</div>
                    {Array.isArray(timings) && timings.map((time, i) => (
                        <div key={i} className="timings">

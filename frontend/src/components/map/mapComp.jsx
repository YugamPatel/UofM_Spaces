...
mapboxgl.accessToken = "pk.eyJ1IjoieXVnYW0tMDA3IiwiYSI6ImNtN2Y5dnB2bjBoODYybW44MDRtYXZqcjAifQ.b9U8tqIEN8w3HQYTO9ZqBA";
...
const MapComp = () => {
  ...
  useEffect(() => {
    ...
    markerEl.className = "marker"; // See .marker style in CSS
